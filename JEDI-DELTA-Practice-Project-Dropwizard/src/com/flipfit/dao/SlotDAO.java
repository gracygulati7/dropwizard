...
public class SlotDAO {
    ...
    public Slot addSlotAuto(Slot slot) {
        String query = "INSERT INTO slots (centre_id, slot_date, start_time, end_time, total_seats, available_seats) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = getConnection(); PreparedStatement stmt = conn.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            stmt.setTime(3, convertToSqlTime(slot.getStartTime()));
            stmt.setTime(4, convertToSqlTime(slot.getEndTime()));
